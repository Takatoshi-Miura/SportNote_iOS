...
let TITLE_APP_VERSION = NSLocalizedString("AppVersion", comment: "")
...
let TITLE_TOURNAMENT_NOTE = NSLocalizedString("TournamentNote", comment: "")
...
let TITLE_UNCATEGORIZED = NSLocalizedString("Uncategorized", comment: "")
...
let TITLE_SYSTEM_INFO = NSLocalizedString("SystemInfo", comment: "")
let TITLE_TEST = NSLocalizedString("Test", comment: "")
let TITLE_CRASHLYTICS_TEST = NSLocalizedString("CrashlyticsTest", comment: "")
...
let ERROR_MESSAGE_TARGET_EXIST = NSLocalizedString("TargetExistError", comment: "")
let ERROR_MESSAGE_NOTE_CREATE_FAILED = NSLocalizedString("NoteCreateError", comment: "")
