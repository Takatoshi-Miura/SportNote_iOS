//
//  RealmGroupXCTest.swift
//  
//
//  Created by Takatoshi Miura on 2024/10/04.
//
...
final class RealmGroupXCTest: XCTestCase {
    ...
    func testGetGroupByID() {
        ...
        XCTAssertEqual(result.title, "IDテスト用グループ")
        XCTAssertEqual(result.color, Color.green.rawValue)
    }
